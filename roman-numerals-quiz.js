...
// First, convert the Roman numerals into the values they represent.
// Then, run logic to find out if you need to subtract any of the values from another to get the correct answer:
// until you get to much larger numbers, the only times you need to subtract as opposed to simply totaling the
// numbers is when you have a 4 or a 9, in which cases the last numeral is not equal to 1 AND the second to last
// numeral is equal to 1. So, if these two conditions exist, simply replace the last two numerals with their
// difference (either 10 - 1 = 9 or 5 - 1 = 4) and find the sum of the remaining numerals using an accumulator
